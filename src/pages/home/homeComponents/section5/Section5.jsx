  ...
  return (
    <div className="section-bg border-b-8 border-yellow-300">
      <div className="w-11/12 max-w-screen-2xl mx-auto relative z-50">
        <h1 className="text-white text-center text-3xl font-medium py-9">
        ...
        <ul className="flex flex-col gap-7 pb-9">
                <li> <h1 className="text-2xl text-center">Brown Country</h1></li>
                <hr className="border-b-[1px] border-white " />
                <li> <h1 className="text-2xl text-center">Cass Country</h1> </li>
                <hr className="border-b-[1px] border-white " />
                <li> <h1 className="text-2xl text-center">Greene Country</h1> </li>
                <hr className="border-b-[1px] border-white " />
                <li> <h1 className="text-2xl text-center">Jersey Country</h1> </li>
            </ul>
            <ul className="flex flex-col gap-7">
                <li> <h1 className="text-2xl text-center"> Pike Country</h1></li>
                <hr className="border-b-[1px] border-white " />
                <li> <h1 className="text-2xl text-center">Pittsfield, IL</h1> </li>
                <hr className="border-b-[1px] border-white " />
                <li> <h1 className="text-2xl text-center">Scott Country</h1> </li>
                <hr className="border-b-[1px] border-white " />
                <li> <h1 className="text-2xl">Schuyler Country</h1> </li>
            </ul>
