...
const Section2 = () => {
  return (
    <div className='bg-[#16163F0D] py-12'>
      ...
      <div className='flex flex-col lg:flex-row gap-10 justify-center items-center py-7'>
        <div className='w-96 h-52 bg-white p-7 shadow-xl flex items-center border-t-4 border-[#6C6B7D] hover:border-yellow-300 transition-0.3'>
            <img src={img1} alt="" />
        </div>
        <div className='w-96 h-52 bg-white p-7 shadow-xl flex items-center border-t-4 border-[#6C6B7D] hover:border-yellow-300 transition-0.3'>
            <img src={img2} alt="" />
