...
const Section2 = () => {
  return (
    <div className='bg-[#16163F0D] py-12'>
      ...
      <h1 className=' text-2xl lg:text-4xl text-center font-medium'>YOUR ATTORNEY FOR CRIMINAL DEFENSE, FAMILY LAW MATTERS, TRAFFIC VIOLATIONS, DUI CHARGES & MORE IN JACKSONVILLE ILLINOIS AND THROUGHOUT MORGAN COUNTY</h1>
